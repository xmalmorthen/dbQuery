...
*/
$config['composer_autoload'] = FALSE; //$cnfg->general->environment == 'development' ? FCPATH.'vendor/autoload.php' : "";;
...
|
*/
$config['encryption_key'] = 'Query by XmalMorthen';
...
$config['sess_cookie_name'] = 'querySess';
...
$config['csrf_token_name'] = 'csrf_QUERY';
$config['csrf_cookie_name'] = 'csrf_QUERY';
